...
def fonksiyon(deger):
    if deger == 0:
        return 1
    return deger * fonksiyon(deger - 1)
x = int(input("Hangi Sayının Fonksiyonu Alınsın?  = "))
print(fonksiyon(x))
# --------------------------------------------------------------------------------
#     3. Question
...
sayi = int(input("Hangi Sayıya Kadar Sayılarin Karesi Yazılsın?  = "))
dizi2 = {}
...
#     ['34', '67', '55', '33', '12', '98']
#     ('34', '67', '55', '33', '12', '98')
dizi3 = input("Sayıları ',' İle Ayırarak Yazınız = ").split(",")
t = tuple(dizi3)
print(dizi3)
print(t)
# --------------------------------------------------------------------------------
...
H = 30
value = []
items = [x for x in input("Sayılarınızı ','ile Ayırarak Yazınız. = ").split(",")]
for d in items:
...
#     Operator modülünü araştırmalısın.(itemgetter, attrgetter)
...
#     0 ila girilen sayı arasında 7 ile bölünenleri yazdır
