...
# burası
    for buffer in range(len(pcdestesi)):
        ...
        if krakam == "Değiştirici":
            renk = renkdizisi[random.randint(len(renkdizisi))]
            orta = renk + " Değiştirici"
...
# Pc destesi end of the line
renkdizisi = ["Kırmızı", "Mavi", "Sarı", "Yeşil"]
deste = []
for i in range(10):
...
print(len(deste))
"""
Burasının amacı yukarı yapılan karıştırmanın doğruluğunu bulma
